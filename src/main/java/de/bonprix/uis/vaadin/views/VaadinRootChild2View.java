...
@SpringView(name = VaadinRootChild2View.VIEW_NAME, parentName = VaadinRootChild2View.VIEW_PARENT_NAME, ui = {
		VaadinUI.class })
public class VaadinRootChild2View extends VerticalLayout implements View {
	...
	void init() {
		...
		addComponent(new Label(
				"This is a <i>child view</i> for the <i>VaadinUI</i> for <i>Root</i>, defined by the annotation <b>@SpringView(parentName = \"Root\", ui = { VaadinUI.class })</b>.",
				ContentMode.HTML));
		setMargin(true);
		setSpacing(true);
	}
